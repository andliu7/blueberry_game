...
export const PATHWAY_UNITS: readonly PathwayUnit[] = [
  {
    ...
    nodes: [
      ...
      { id: "u1-12v14", kind: "spine", title: "1,2- vs 1,4-addition of HX", blurb: "Kinetic 1,2 cold, thermodynamic 1,4 warm." },
      { id: "u1-kvt", kind: "spine", title: "Kinetic vs thermodynamic control", blurb: "Hammond postulate, reaction coordinate diagrams." },
      { id: "u1-x2", kind: "spine", title: "X₂ addition to dienes", blurb: "Br₂, Cl₂ → 1,2- and 1,4-dihalides, same allylic-cation logic." },
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "u3-halo", kind: "spine", title: "Halogenation", blurb: "Cl₂/FeCl₃; Br₂/FeBr₃; I₂ needs an oxidant." },
      { id: "u3-nitration", kind: "spine", title: "Nitration", blurb: "HNO₃/H₂SO₄, electrophile NO₂⁺.", playable: { kind: "sequence", id: "seq-eas" } },
      { id: "u3-sulfo", kind: "spine", title: "Sulfonation and desulfonation", blurb: "Reversible, which is what makes it a blocking group." },
      { id: "u3-fc-acyl", kind: "spine", title: "Friedel–Crafts acylation", blurb: "RCOCl/AlCl₃; no rearrangement, self-limiting." },
      ...
      { id: "u3-c-to-ch2", kind: "spine", title: "Carbonyl → CH₂ after acylation", blurb: "Clemmensen or Wolff–Kishner: the unrearranged alkyl chain." },
  ...
  },
  {
    ...
    nodes: [
      { id: "u4-snar", kind: "spine", title: "SNAr addition–elimination", blurb: "Aryl halide with o/p EWG + a nucleophile." },
      { id: "u4-meisenheimer", kind: "spine", title: "Meisenheimer complex", blurb: "Drawing the charge onto the nitro oxygen is the exam question." },
      { id: "u4-lg-order", kind: "spine", title: "Reversed leaving-group order", blurb: "F > Cl > Br > I: addition is rate-determining." },
  ...
  },
  {
    ...
    nodes: [
      { id: "u5-roh-rx", kind: "spine", title: "Alcohol → alkyl halide", blurb: "SOCl₂, PBr₃, HX; inversion where it matters." },
      { id: "u5-tosylate", kind: "spine", title: "Tosylate / mesylate", blurb: "Bad LG to good LG with retention." },
      ...
      { id: "u5-epoxidation", kind: "spine", title: "Epoxidation", blurb: "mCPBA, syn and stereospecific; or halohydrin + base." },
      ...
      { id: "u5-anti-diol", kind: "spine", title: "Anti-dihydroxylation", blurb: "mCPBA then H₃O⁺ → trans-diol. Teach as a pair with syn." },
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "u7-acetal", kind: "spine", title: "Hemiacetal and acetal", blurb: "Every arrow reversible, pushed both directions." },
      ...
      { id: "u7-enamine", kind: "spine", title: "Enamine formation", blurb: "2° amine; sets up Stork chemistry in Unit 9." },
      ...
      { id: "u7-hydride", kind: "spine", title: "Hydride reduction", blurb: "NaBH₄ mild, LiAlH₄ strong." },
      { id: "u7-wittig", kind: "spine", title: "Wittig olefination", blurb: "Ylide → alkene with unambiguous placement." },
      { id: "u7-12v14", kind: "spine", title: "1,2 vs 1,4 selectivity on enones", blurb: "Hard 1,2, soft 1,4; the node Unit 9 depends on." },
      { id: "u7-to-ch2", kind: "spine", title: "Reduction to CH₂", blurb: "Clemmensen, Wolff–Kishner, thioacetal/Raney Ni." },
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "u8-to-acylcl", kind: "spine", title: "Acid → acyl chloride", blurb: "SOCl₂, oxalyl chloride: climbing the ladder." },
      { id: "u8-to-anhydride", kind: "spine", title: "Acid → anhydride", blurb: "Heat a diacid, or acid + acyl chloride." },
      { id: "u8-fischer", kind: "spine", title: "Fischer esterification", blurb: "Reversible; drive with excess or remove water." },
      ...
      { id: "u8-anhydride", kind: "spine", title: "Anhydride → ester/amide/acid", blurb: "Same partners, slower, one acyl wasted." },
      { id: "u8-hydrolysis", kind: "spine", title: "Ester hydrolysis", blurb: "Acidic reversible; saponification irreversible." },
      { id: "u8-transester", kind: "spine", title: "Transesterification", blurb: "Same tetrahedral logic, equilibrium-driven." },
      { id: "u8-amide-hyd", kind: "spine", title: "Amide hydrolysis", blurb: "Forcing conditions; why amides resist is the concept." },
      { id: "u8-nitrile", kind: "spine", title: "Nitrile chemistry", blurb: "From R–X + CN⁻ or amide dehydration; hydrolysis back." },
      { id: "u8-lialh4", kind: "spine", title: "LiAlH₄ reductions", blurb: "Acid/ester → alcohol; amide → amine; nitrile → amine." },
      { id: "u8-dibal", kind: "spine", title: "DIBAL-H partial reduction", blurb: "One equivalent, cold: stop at the aldehyde." },
      { id: "u8-organomet", kind: "spine", title: "Organometallics on derivatives", blurb: "Two additions on esters; over-addition unavoidable." },
      { id: "u8-gilman", kind: "spine", title: "Gilman + acyl chloride", blurb: "Stops cleanly at the ketone." },
      { id: "u8-decarb", kind: "spine", title: "Decarboxylation", blurb: "β-keto acids, 6-membered TS. Load-bearing for Unit 9." },
  ...
  },
  {
    ...
    nodes: [
      { id: "u9-tautomer", kind: "spine", title: "9a · Keto–enol tautomerism", blurb: "Acid- and base-catalyzed, both directions." },
      ...
      { id: "u9-halo-acid", kind: "spine", title: "9a · α-Halogenation, acid", blurb: "Stops at mono; halogen deactivates the enol." },
      { id: "u9-halo-base", kind: "spine", title: "9a · α-Halogenation, base", blurb: "Runs away: each halogen acidifies the rest." },
      ...
      { id: "u9-aldol-cond", kind: "spine", title: "9b · Aldol condensation", blurb: "E1cb dehydration; conjugation drives it." },
      { id: "u9-crossed", kind: "spine", title: "9b · Crossed / mixed aldol", blurb: "No-α-H partner, or a preformed enolate." },
      { id: "u9-intra", kind: "spine", title: "9b · Intramolecular aldol", blurb: "5- and 6-membered rings win." },
      { id: "u9-claisen", kind: "spine", title: "9b · Claisen condensation", blurb: "Stoichiometric base pulls the equilibrium." },
      { id: "u9-dieckmann", kind: "spine", title: "9b · Dieckmann", blurb: "Intramolecular Claisen → cyclic β-ketoester." },
      { id: "u9-crossed-claisen", kind: "spine", title: "9b · Crossed Claisen", blurb: "One ester with no α-H." },
      { id: "u9-alkylation", kind: "spine", title: "9c · Enolate alkylation", blurb: "Preformed enolate + 1° R–X." },
      { id: "u9-malonic", kind: "spine", title: "9c · Malonic ester synthesis", blurb: "Alkylate, hydrolyze, decarboxylate." },
      { id: "u9-acetoacetic", kind: "spine", title: "9c · Acetoacetic ester synthesis", blurb: "Same three-step logic; methyl ketone out." },
      { id: "u9-michael", kind: "spine", title: "9c · Michael addition", blurb: "Soft nucleophile, 1,4." },
      { id: "u9-cuprate", kind: "spine", title: "9c · Conjugate organocuprate", blurb: "Unstabilized alkyl delivered 1,4." },
      { id: "u9-robinson", kind: "spine", title: "9c · Robinson annulation", blurb: "Michael then intramolecular aldol condensation." },
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "u10-red-amination", kind: "spine", title: "Reductive amination", blurb: "NaBH₃CN reduces the iminium, not the carbonyl." },
      { id: "u10-amide-red", kind: "spine", title: "Amide reduction", blurb: "LiAlH₄, keeping the substitution pattern." },
      { id: "u10-nitrile-red", kind: "spine", title: "Nitrile reduction", blurb: "Adds one carbon on the way to the amine." },
      { id: "u10-nitro-red", kind: "spine", title: "Nitro reduction", blurb: "The Unit 3 to Unit 10 bridge." },
      { id: "u10-diazonium", kind: "spine", title: "Diazonium formation", blurb: "NaNO₂/HCl at 0–5 °C, no negotiation on temperature." },
      { id: "u10-diazo-sub", kind: "spine", title: "Diazonium substitution", blurb: "Sandmeyer and friends; NH₂ as a temporary director." },
      { id: "u10-acyl-protect", kind: "spine", title: "Amine acylation as protection", blurb: "Ac₂O moderates aniline for controlled EAS." },
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "u11-phenoxide", kind: "spine", title: "Phenoxide as nucleophile", blurb: "Williamson to aryl ethers; esters." },
