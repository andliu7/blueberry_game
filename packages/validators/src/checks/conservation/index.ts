 ...
 *
 * Eleven checks, one export. src/checks/index.ts spreads this array into the registry, so
 ...
 * Step identity is last of all, because it is the only check that reads what a step CLAIMS
 * to be rather than what it does, and a step whose label is wrong is still worth reporting
 * after everything about its electrons has been agreed.
 *
