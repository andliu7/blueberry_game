...
export const VALENCE_COPY: Readonly<Record<ValenceCauseId, CauseCopy>> = Object.freeze({
  valence_exceeded: {
    whatYouDid: "You gave an atom more bonds than it can hold.",
  ...
  octet_expanded_on_period_two: {
    whatYouDid: "You put more than eight valence electrons around a second row atom.",
  ...
  impossible_hydrogen_count: {
    whatYouDid: "You took more hydrogens off an atom than it had.",
    why: "Hydrogens that are not drawn are still real atoms. An atom cannot carry a negative number of them, so the structure you asked for does not exist.",
  ...
  formal_charge_disagrees_with_structure: {
    whatYouDid: "You wrote a charge on an atom that does not match the electrons drawn around it.",
    why: "Formal charge is not a label you pick separately. It is the free atom's valence electron count, minus the electrons in its lone pairs, minus one for each bond. Oxygen with three bonds and one lone pair comes out at plus one no matter what symbol is written beside it.",
    lookAt: "Do that subtraction at the highlighted atom. If the answer is the charge you wanted, the structure is right and the symbol is wrong. If it is not, a bond or a lone pair is in the wrong place.",
  },
  electron_count_not_integral: {
    whatYouDid: "You left an atom holding a fraction of an electron.",
